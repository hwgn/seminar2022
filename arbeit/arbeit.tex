...
% Soll zum Beispiel eine Chatanwendung realisiert werden, so muss der Server neue Nachrichten an alle verbundenen Clients senden können.
% Dies kann nicht ohne weiteres funktionieren, da unter HTTP nur der Client Daten anfragen oder versenden kann.
% 
...
% 
% Die Seminararbeit soll sich ausschließlich mit der Realisierung einer bidirektionalen Kommunikation zwischen Client und Server beschäftigen.
...
% fortgeschrittene Algorithmen wie das Nyquist-Shannon-Abtasttheorem werden nicht behandelt.
% 
% \section{Vorgehen}
% 
