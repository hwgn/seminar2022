...
\lstinputlisting[caption={Polling Server: Nachrichten abfragen}, label={lst:polling-server-polling}, firstlineandnumber=31, lastline=42]{../code/server/chatserver.ts}
...
\lstinputlisting[caption={Polling Server: Nachrichten abfragen}, label={lst:polling-server-send-message}, firstlineandnumber=43, lastline=53]{../code/server/chatserver.ts}
...
\lstinputlisting[caption={Polling Client: Nachrichten abfragen}, label={lst:polling-client-send-messages}, firstlineandnumber=14, lastline=22]{../code/client/src/components/PollingChat.vue}
...
\lstinputlisting[caption={Polling Client: Nachrichten abfragen}, label={lst:polling-client-get-messages}, firstlineandnumber=24, lastline=44]{../code/client/src/components/PollingChat.vue}
...
\lstinputlisting[caption={Long Polling Server: Nachrichten abfragen}, label={lst:long-polling-server-get-messages}, firstlineandnumber=77, lastline=82]{../code/server/chatserver.ts}

Geht eine neue Nachricht ein, wird diese an alle bis dahin erhaltenen offenen Verbindungen gesendet.

\lstinputlisting[caption={Long Polling Server: Nachrichten versenden}, label={lst:long-polling-server-send-messages}, firstlineandnumber=90, lastline=106]{../code/server/chatserver.ts}
...
\lstinputlisting[caption={Long Polling Client: Nachrichten abfragen}, label={lst:long-polling-client-get-messages}, firstlineandnumber=25, lastline=41]{../code/client/src/components/LongPollingChat.vue}
...
\lstinputlisting[caption={Streaming Server: Nachrichten abfragen}, label={lst:streaming-server-get-messages}, firstlineandnumber=123, lastline=140]{../code/server/chatserver.ts}

Geht eine neue Nachricht ein, wird diese an Verbindungen gesendet.

\lstinputlisting[caption={Streaming Server: Nachrichten versenden}, label={lst:streaming-server-send-messages}, firstlineandnumber=141, lastline=156]{../code/server/chatserver.ts}
...
\lstinputlisting[caption={Streaming Client: Nachrichten abfragen}, label={lst:streaming-client-get-messages}, firstlineandnumber=23, lastline=49]{../code/client/src/components/StreamingChat.vue}
...
\lstinputlisting[caption={WebSocket Server}, label={lst:websocket-server}, firstlineandnumber=168, lastline=177]{../code/server/chatserver.ts}
